...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def __init__(self, cfg, dictionary, embed_tokens, return_fc=False):
        ...
        self.embed_pos_tags = Embedding(
            len(dictionary), embed_dim, dictionary.pad())
        ...
        self.embed_pos_scale = 1.0 if cfg.no_scale_embedding else math.sqrt(
            embed_dim
        )
    ...
    def forward_embedding(
        self, src_tokens, token_embedding: Optional[torch.Tensor] = None, encoder_ids=None
    ):
        ...
        if encoder_ids is not None:
            y = (self.embed_pos_tags(encoder_ids) * self.embed_pos_scale)
            x = x + y
    ...
    def forward(
        ...
        **kwargs
        ...
        return self.forward_scriptable(
            src_tokens, src_lengths, return_all_hiddens, token_embeddings, encoder_ids=encoder_ids
        )
    ...
    def forward_scriptable(
        ...
        x, encoder_embedding = self.forward_embedding(
            src_tokens, token_embeddings, encoder_ids)

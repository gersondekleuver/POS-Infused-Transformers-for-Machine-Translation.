...
def create_conv_dict(model, penalty):
    ...
    # if not os.path.isfile(f'./data-bin/wmt14_en_de/conv_dicts/conv_dict_{penalty}.pkl'):
    ...
    def generate(self, models, sample, prefix_tokens=None, constraints=None):
        ...
        for step in range(self.max_iter + 1):
            ...
            decoder_out = model.forward_decoder(
                prev_decoder_out, encoder_out, conv_dict=conv_dict, pos_sentences=pos_tag_sentences, **decoder_options
            )

...
def ensemble_decoder(func):
    def wrapper(self, normalize=False, encoder_out=None, pos_ids=None, *args, **kwargs):
        if self.ensemble_models is None or len(self.ensemble_models) == 1:
            return func(
                self, normalize=normalize, encoder_out=encoder_out, pos_ids=pos_ids, *args, **kwargs
            )

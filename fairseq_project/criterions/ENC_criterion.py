...
@register_criterion("ENC_criterion", dataclass=LabelSmoothedDualImitationCriterionConfig)
class LabelSmoothedDualImitationCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, pos_model, reduce=True):
        ...
        #### POSDP ####
        pos_target = sample["pos"]
        pos_predict = sample["pos_predict"]

        #### POSDP ####

        outputs = model(src_tokens, src_lengths,
                        prev_output_tokens, tgt_tokens, encoder_ids=pos_target, pos_ids=pos_predict)
        losses, nll_loss = [], []

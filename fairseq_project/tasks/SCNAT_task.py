...
@dataclass
class SCNATTranslationLevenshteinConfig(SCNATTranslationConfig):
...
@register_task("SCNAT_task", dataclass=SCNATTranslationLevenshteinConfig)
class TranslationLevenshteinTask_v3(SCNAT_translation):
    """
    Translation (Sequence Generation) task for Levenshtein Transformer
    See `"Levenshtein Transformer" <https://arxiv.org/abs/1905.11006>`_.
    Added POS tagging model initialization and forward pass.
    """
    cfg: SCNATTranslationLevenshteinConfig

    def __init__(self, cfg: SCNATTranslationLevenshteinConfig, src_dict, tgt_dict):
    ...
    def build_generator(self, models, args, **unused):
        ...
        from ..models.SCNAT.iterative_refinement_generator_SCNAT import IterativeRefinementGenerator

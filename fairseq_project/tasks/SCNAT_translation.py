...
@dataclass
class SCNATTranslationConfig(FairseqDataclass):
...
@register_task("SCNAT_translation", dataclass=SCNATTranslationConfig)
class SCNAT_translation(FairseqTask):
    """	
    ...
    cfg: SCNATTranslationConfig

    def __init__(self, cfg: SCNATTranslationConfig, src_dict, tgt_dict):
        super().__init__(cfg)
        self.src_dict = src_dict
        self.tgt_dict = tgt_dict

    @classmethod
    def setup_task(cls, cfg: SCNATTranslationConfig, **kwargs):

...
@dataclass
class POSDPTranslationConfig(FairseqDataclass):
...
@register_task("POSDP_translation", dataclass=POSDPTranslationConfig)
class POSDP_translation(FairseqTask):
    """	
    ...
    cfg: POSDPTranslationConfig

    def __init__(self, cfg: POSDPTranslationConfig, src_dict, tgt_dict):
        super().__init__(cfg)
        self.src_dict = src_dict
        self.tgt_dict = tgt_dict

    @classmethod
    def setup_task(cls, cfg: POSDPTranslationConfig, **kwargs):
